...
const bit<3> META_CODE_NONE = 0;
const bit<3> META_CODE_UNICAST = 1;
...
parser SwitchIngressParser(
    ...
    state accept_unicast {
        ig_md.code = META_CODE_UNICAST;
        transition accept;
    }

    state parse_neo {
        pkt.extract(hdr.neo);
        ig_md.code = META_CODE_MULTICAST;
        transition accept;
    }
